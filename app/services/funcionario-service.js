...
var FuncionarioService = (function () {
    function FuncionarioService(http, httpUtil) {
        this.http = http;
        this.httpUtil = httpUtil;
        this.path = 'funcionarios';
    }
    FuncionarioService.prototype.listarTodos = function () {
        return this.http.get(this.httpUtil.url(this.path), this.httpUtil.headers())
            .map(this.httpUtil.extrairDados)
            .catch(this.httpUtil.processarErros);
    };
    FuncionarioService.prototype.cadastrar = function (funcionario) {
        var params = JSON.stringify(funcionario);
        return this.http.post(this.httpUtil.url(this.path), params, this.httpUtil.headers())
            .map(this.httpUtil.extrairDados)
            .catch(this.httpUtil.processarErros);
    };
    FuncionarioService.prototype.atualizar = function (funcionario) {
        var params = JSON.stringify(funcionario);
    ...
    FuncionarioService.prototype.buscarPorId = function (id) {
