...
var ApontamentoService = (function () {
    function ApontamentoService(http, httpUtil) {
        this.http = http;
        this.httpUtil = httpUtil;
        this.path = 'apontamentos';
    }
    ApontamentoService.prototype.listarTodos = function () {
        return this.http.get(this.httpUtil.url(this.path), this.httpUtil.headers())
            .map(this.httpUtil.extrairDados)
            .catch(this.httpUtil.processarErros);
    };
    ApontamentoService.prototype.cadastrar = function (apontamento) {
        var params = JSON.stringify(apontamento);
        return this.http.post(this.httpUtil.url(this.path), params, this.httpUtil.headers())
            .map(this.httpUtil.extrairDados)
            .catch(this.httpUtil.processarErros);
    };
    ApontamentoService.prototype.atualizar = function (apontamento) {
        var params = JSON.stringify(apontamento);
        return this.http.put(this.httpUtil.url(this.path), params, this.httpUtil.headers())
            .map(this.httpUtil.extrairDados)
            .catch(this.httpUtil.processarErros);
    };
    ApontamentoService.prototype.excluir = function (id) {
        return this.http.delete(this.httpUtil.url(this.path + '/' + id), this.httpUtil.headers())
            .map(this.httpUtil.extrairDados)
            .catch(this.httpUtil.processarErros);
    };
    ApontamentoService.prototype.buscarPorId = function (id) {
...
exports.ApontamentoService = ApontamentoService;
//# sourceMappingURL=apontamento-service.js.map